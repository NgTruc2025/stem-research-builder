...
const GEMINI_MODELS = [
  ...
  { id: "gemini-2.5-flash", label: "Gemini 2.5 Flash", description: "Mới nhất, thông minh" },
  { id: "gemini-1.5-flash-latest", label: "Gemini 1.5 Flash", description: "Ổn định, quota cao" },
  { id: "gemini-1.5-pro-latest", label: "Gemini 1.5 Pro", description: "Chất lượng cao nhất" },
];
